    ...
    private static String isFromStackPopAndPush(String template,String pattern){
        ...
        while (tempPointer<length){
            if (templateArr[tempPointer]!=patternArr[patPointer]){
                ...
                operations.append((count++)+"、push ("+templateArr[tempPointer]+") " );
                tempPointer++;
            }
            else {
                operations.append((count++)+"、push ("+templateArr[tempPointer]+") "+(count++)+"、pop ("+templateArr[tempPointer]+") " );
                patPointer++;
                while (!stack.isEmpty()&&stack.top()==patternArr[patPointer]){
                    Character pop = stack.pop();
                    operations.append((count++)+"、pop ("+pop+") " );
                    patPointer++;
                }
                tempPointer++;
            }
